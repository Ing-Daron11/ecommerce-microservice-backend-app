...
public class ApiExceptionHandler {
	...
	@ExceptionHandler(value = {
			InvalidFavouriteDataException.class
	})
	public <T extends RuntimeException> ResponseEntity<ExceptionMsg> handleInvalidDataException(final T e) {

		log.info("**ApiExceptionHandler controller, handle invalid data exception*\n");
		final var badRequest = HttpStatus.BAD_REQUEST;
