...
![Construcción del proyecto](images/image.png)

**Compilar servicios**
```bash
mvn clean package -DskipTests
```
![Compilación de servicios](images/image-1.png)
...
![Build Docker](images/image-2.png)
...
# ... resto de servicios
```
![Despliegue K8s](images/image-3.png)
...
```
![Tests de Integración](images/image-4.png)
...
![Pipeline Dev](images/image-6.png)
...
![Pipeline Stage](images/image-5.png)
...
![Zipkin Dependencies](images/image-8.png)
